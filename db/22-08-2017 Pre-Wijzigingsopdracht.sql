...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 22, 2017 at 09:27 AM
...
INSERT INTO `klacht` (`idKlacht`, `idUser`, `klacht`) VALUES
(1, 10, '123');
...
INSERT INTO `orderregel` (`idOrderregel`, `idProduct`, `idOrder`, `prijsOr`, `aantal`, `verkochtViaMeestVerkocht`) VALUES
(5, 985632, 31, 95000, 1, 0);
...
INSERT INTO `producten` (`idProduct`, `naam`, `beschrijving`, `prijs`, `foto`, `beschikbaar`, `aantalBeschikbaar`, `aantalVerkocht`, `isAccessoire`, `type`) VALUES
(985632, 'Tesla Model X', 'Tesla Model X', 95000, 'teslaModelX.jpg', 1, 4, 1, 0, 1),
...
(10, 'Marielle van Dijk', 'marielle@mail.nl', '202cb962ac59075b964b07152d234b70', 'Kamille 1', 'Culemborg', 3, 2, 1, '2017-06-10', 0),
(11, 'Marielle van Dijk', 'marielle2@mail.nl', 'cc86dee7f6cf9b13b0d307600f8c4167', 'Kamille 12', 'Culemborg', 4, 1, 0, '2017-06-15', 0),
(14, 'Admin de Admin', 'admin@mail.nl', '202cb962ac59075b964b07152d234b70', 'Adminstraat 1', 'Admin', 3, 1, 1, '2017-06-22', 0);
...
ALTER TABLE `producten`
  ADD CONSTRAINT `fk_Producten_Type` FOREIGN KEY (`type`) REFERENCES `type` (`idType`) ON DELETE NO ACTION ON UPDATE NO ACTION;
