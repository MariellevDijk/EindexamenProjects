...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 14, 2016 at 01:20 PM
...
CREATE TABLE IF NOT EXISTS `bestelling` (
  ...
  `adresKlant` varchar(255) NOT NULL,
  `woonplaatsKlant` varchar(255) NOT NULL,
...
INSERT INTO `bestelling` (`idBestelling`, `idVideo`, `idKlant`, `afleverdatum`, `ophaaldatum`, `prijs`, `adresKlant`, `woonplaatsKlant`, `emailKlant`) VALUES
...
(19, 1, 11, '2016-10-21', '2016-10-28', 9.5, '', '', ''),
(20, 1, 11, '2016-10-30', '2016-11-06', 9.5, '', '', ''),
(21, 1, 18, '2016-10-25', '2016-11-01', 9.5, '', '', '');
...
(1, 11, 'Git gud ', 'klant@mail.nl'),
(2, 11, 'Git gud m8', 'klant@mail.nl'),
...
(1, 'The Dark Knight', 'When the menace known as the Joker wreaks havoc and chaos on the people of Gotham, the caped crusader must come to terms with one of the greatest psychological tests of his ability to fight injustice.', 'the_dark_knight.jpg', 7.5, 9, 1, 1),
...
(4, 'Frozen', 'When the newly crowned Queen Elsa accidentally uses her power to turn things into ice to curse her home in infinite winter, her sister, Anna, teams up with a mountain man, his playful reindeer, and a snowman to change the weather condition.', 'frozen.jpg', 7.5, 2, 1, 0),
...
(8, 'Zootopia', 'In a city of anthropomorphic animals, a rookie bunny cop and a cynical con artist fox must work together to uncover a conspiracy.', 'zootopia.jpg', 7.5, 8, 1, 0);
