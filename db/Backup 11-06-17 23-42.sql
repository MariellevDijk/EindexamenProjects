...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 11, 2017 at 11:42 PM
...
INSERT INTO `order` (`idOrder`, `idUser`, `totaalPrijs`) VALUES
(28, 10, 86);
...
INSERT INTO `orderregel` (`idOrderregel`, `idProduct`, `idOrder`, `prijs`, `aantal`) VALUES
(1, 1, 28, 40, 2),
(2, 4, 28, 46, 2);
...
INSERT INTO `producten` (`idProduct`, `naam`, `beschrijving`, `prijs`, `foto`, `beschikbaar`, `aantal`, `aantalVerkocht`) VALUES
(1, 'Saw', 'saw', 20, 'saw.jpg', 1, 8, 2),
(4, 'Saw 2', 'Saw 2', 23, 'saw.jpg', 1, 48, 2);
